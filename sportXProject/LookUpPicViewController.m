...
#pragma mark  测试
    ...
    NSString*imageUrl=[_imageArray objectAtIndex:_index];
    _imageView=[[YockPhotoImgView alloc] initWithFrame:CGRectMake(WIDTH*_index, -30, WIDTH, _scrollView.bounds.size.height)];
    _imageView.contentMode = UIViewContentModeScaleAspectFit;
    [_imageView setImage:[UIImage imageNamed:@"0006.png"]];
    [_imageView sd_setImageWithURL:[NSURL URLWithString:imageUrl] placeholderImage:[UIImage imageNamed:@"default"] options:SDWebImageCacheMemoryOnly progress:^(NSInteger receivedSize, NSInteger expectedSize) {
        //创建显示进度的视图
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    NSString*imageUrl=[_imageArray objectAtIndex:nowPage];
