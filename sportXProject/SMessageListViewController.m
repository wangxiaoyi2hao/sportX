//
//  SMessageListViewController.m
//  sportXProject
//
//  Created by lsp's mac pro on 16/6/13.
...
@interface SMessageListViewController ()

@end

@implementation SMessageListViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
//    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(reftsetGoGO) name:@"刷新列表谢谢" object:nil];
    //设置需要显示哪些类型的会话
...
- (void)didTapCellPortrait:(RCConversationModel *)model{
    if (model.conversationType == ConversationType_PRIVATE) {
        ...
        infoTVC.fromUserId=[model.targetId intValue];
