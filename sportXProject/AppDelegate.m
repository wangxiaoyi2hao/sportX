...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    home.tabBarItem.image=[UIImage imageNamed:@"tab_news.png"];
    OutSignViewController*web=[[OutSignViewController alloc]init];
    web.tabBarItem.title=@"关注";
    web.tabBarItem.image=[UIImage imageNamed:@"tab_friends.png"];
...
//    center.tabBarItem.image=[UIImage imageNamed:@"tab_me.png"];
    ...
    setting.tabBarItem.image=[UIImage imageNamed:@"tab_setting.png"];
